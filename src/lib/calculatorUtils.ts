...
import { CurrencyType, formatCurrency as formatCurrencyByType } from './currencyUtils';

/**
 * Formats a number as currency
 */
export function formatCurrency(value: number, currency: CurrencyType = 'USD'): string {
  return formatCurrencyByType(value, currency);
}
